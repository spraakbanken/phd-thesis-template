...
% Uncomment the following line if you're not getting a glossary at all; note that you'll get a compiler error if your glossary is empty
%\usepackage[xindy,acronym,automake=immediate]{glossaries}
\glsdisablehyper
\makeglossaries
\import{\BibPath}{glossary}

% Preventing widows and orphans in text
\usepackage[all]{nowidow}   % USE THIS ONLY AT THE END!!!!
                            % Fixing things on your own will give you much better spacing
...
% This allows us to hide stuff from the TOC
\newcommand{\nocontentsline}[3]{}
\newcommand\stoptoc{%
...
% This allows us to use the RQs as references
\makeatletter
\newcommand{\labitem}[2]{%
...
% This allows us to have max. two authors when citing
% But displaying everyone correctly on the fullcite
\makeatletter
